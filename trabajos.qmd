...
La nota de este trabajo equivale a un **30%** de la nota final del curso, donde 25% equivale al reporte escrito y 5% a una cápsula de presentación de los principales resultados.
...
- [ Encuesta de Bienestar Social EBS 2023](https://observatorio.ministeriodesarrollosocial.gob.cl/encuesta-bienestar-social-2023).
- [ELSOC](https://conferencias.coes.cl/encuesta-panel/)
- [SIMCE](https://informacionestadistica.agenciaeducacion.cl/#/bases) (evt. subset)
- [LAPOP](https://www.vanderbilt.edu/lapop/raw-data.php)
...
- [ENUT](https://www.ine.gob.cl/enut)

# Temas y análisis

- Cada grupo seleccionará **un tema/concepto central** (_variable dependiente_), por ejemplo: prejuicio hacia migrantes, nivel educacional, orientación política, etc. 

- Luego, debe relacionar el tema seleccionado con al menos dos variables (ej: género, nivel socioeconómico, salud, confianza en instituciones, etc.) que serán las _variables independientes_ del reporte. 
  
- Para seleccionar el tema y las variables disponibles se deben revisar los cuestionarios, libros de códigos y reportes de las encuestas mencionadas.
...
Inscribirse en la siguiente [planilla](https://docs.google.com/spreadsheets/d/1kp7Y-SsYvmJyEWF-XsFYO1OVpyOmdHKW8ruKFo4bp-8/edit?gid=0#gid=0) hasta el **Jueves 30 de Octubre**.
...
Los trabajos se desarrollarán en grupos de máximo 5 integrantes. Cada grupo será asignado a un/a ayudante, quienes asesorarán periódicamente a sus grupos. El detalle de las actividades de esta unidad se encuentra en la página de [planificación](/schedule)
...
- Semana 3: escritura de introducción y análisis bivariados. Diseño de cápsula de difusión.
- Semana 4: conclusiones y redacción final, presentación de resultados y entrega de reporte.
