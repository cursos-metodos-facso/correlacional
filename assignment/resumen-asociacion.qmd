...
La correlación es alta, positiva y estadísticamente significativa con un 99,9% de confianza (p<0.001)
...
La correlación es moderada, negativa y estadísticamente significativa con un 99,9% de confianza (p<0.001) 
...
La correlación es negativa y muy baja.
...
El tratamiento mediante listwise-deletion elimina todos aquellos casos en que hay NA en al menos una de las respuestas.

La asociación entre cohesión barrial y edad es positiva, moderada y estadísticamente significativa (p<0.001). La asociación entre educación y edad es negativa, moderada y estadísticamente significativa (p<0.001). La asoicación entre cohesión barrial y educación negativa, muy baja y no es estadísticamente significativa (p>0.05).
...
Los resultados de la prueba $X^2$, indican que existe una asociación estadísticamente significativa entre estas variables ($X^2$ = 6.34, _p < 0.05_).

Esto significa que, según los datos analizados, el sexo es un factor que influye en la cohesión barrial.