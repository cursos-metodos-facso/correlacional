...
En este caso, no podemos rechazar la hipótesis nula ya que su valor p es mayor al nivel de significancia ($p-value = 0.743 > \alpha = 0.05$). Por lo tanto, no hay suficiente evidencia estadística para sostener que los promedios de edad de hombres y mujeres sean diferentes.
...
```{r}
muestra_2 <- data.frame(edad=c(31,35,26,30,24,27,30,31,32,31),
                        sexo=c(1,1,2,1,2,2,2,1,1,1))
