...
b.1) ($H_0$): No existen diferencias en el salario de las mujeres con y sin hijos

b.2) ($H_A$): Promedio salarial de mujeres con hijos será mayor que el promedio salarial de las mujeres sin hijos.
...
Respuesta: Con un 95% de confianza es posible rechazar la hipótesis nula planteada. El promedio salarial de las mujeres con hijos es $124.659,75 mayor que el de las mujeres sin hijos.
...
b1) ($H_0$): No existen diferencias en el promedio salarial según el nivel educacional de las personas.

b2) ($H_A$): Las personas con nivel educacional universitaria tendrán un promedio salarial mayor que las personas de nivel educacional más bajo.
