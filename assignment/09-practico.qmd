...
save(data, file="../assignment/data/data.RData")
```
...
> Podemos caargar los datos en nuestro informe sin que se vea poniendo la option `echo=FALSE`: `data <-load(file="output/data.RData")`.
